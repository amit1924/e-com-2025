...
// //                   className="flex flex-col sm:flex-row items-center p-4 border-b border-gray-700 last:border-b-0"
// //                 >
...
// //                     className="mt-4 sm:mt-0 ml-4 px-3 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors flex items-center"
// //                   >
...
// //               className="mt-6 px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors flex items-center"
// //             >
...
// //               <Link
// //                 to="/checkout"
// //                 className="block w-full text-center px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:opacity-90 transition-opacity font-bold"
// //               >
// //                 Proceed to Checkout
// //               </Link>
// //             </div>
