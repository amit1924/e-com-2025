...
//                 <FiMinus />
//               </button>
//               <span className="px-4 py-2 bg-gray-800 text-white text-center w-12">
//                 {quantity}
//               </span>
//               <button
//                 onClick={() => handleQuantityChange(quantity + 1)}
...
//               className="flex-1 ml-4 flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white py-2 sm:py-3 px-4 sm:px-6 rounded-lg hover:opacity-90 transition-opacity text-sm sm:text-base font-semibold"
//             >
